...
class Solver:
    ...
    def load_model(self):
        self.model = _load_model(self.num_nodes + 1, self.model_prob_maps, weight_file=self.weight_file,
...
def solve(args):
    ...
    logger.info("problem:{},problem scale:{},mean_opt_gap:{},period_time:{}".format(args.problem,node_num,mean_opt_gap, period_time))
